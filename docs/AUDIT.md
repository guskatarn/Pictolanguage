...
4. **Prochain lot —** Rédiger la politique de confidentialité, remplir le formulaire Data safety, vérifier l'attribution ARASAAC et la compatibilité de licence avec le modèle de diffusion choisi (gratuit sans pub obligatoire tant qu'ARASAAC est utilisé).
