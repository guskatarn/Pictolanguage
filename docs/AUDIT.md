...
4. **En cours —** ~~Rédiger la politique de confidentialité~~ ✅ **rédigée le 2026-09-03** (`docs/POLITIQUE-DE-CONFIDENTIALITE.md`, à compléter et héberger), remplir le formulaire Data safety, vérifier l'attribution ARASAAC et la compatibilité de licence avec le modèle de diffusion choisi (gratuit sans pub obligatoire tant qu'ARASAAC est utilisé).
